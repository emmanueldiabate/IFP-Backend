package com.kalanso2manu.IdeeFinancementProjet.security;

import com.kalanso2manu.IdeeFinancementProjet.security.jwt.AuthEntryPointJwt;
import com.kalanso2manu.IdeeFinancementProjet.security.jwt.AuthTokenFilter;
import com.kalanso2manu.IdeeFinancementProjet.security.services.UtilisateursDetailsServiceImpl;
  ...
  public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    http.cors().and().csrf().disable()
        ...
        .antMatchers("/api/bienvenue/**").permitAll()
            ...
            .antMatchers("/AnnonceurExpert/**").permitAll()
            .antMatchers("/secteuractiviter/**").permitAll()
